...
class Obstaculo(Ator):
    _caracter_ativo = 'O' #exemplo de sobrescrita de atributo de classe (uso de atributo de classe economiza memoria)


class Porco(Ator):
    _caracter_ativo = '@'
    _caracter_destruido = '+' # o porco nao some quando eh destruido. '+' significa uma cruz. O teste verifica '+'
...
class Passaro(Ator):
    ...
    def calcular_posicao(self, tempo):
        ...
        :return: posição x, y
        """
        if self._esta_voando():  # para calcular sua posicao primeiramente ele deve ter sido lancado.
